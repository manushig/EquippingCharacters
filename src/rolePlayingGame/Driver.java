...
public class Driver {
  ...
  private static void createGears() {
    ...
    knuckleDuster = new HandGear("Knuckle Duster of Charge", "Charge", 0, new Attack(3));
    ...
    watch = new HandGear("Watch of Explosion", "Explosion", 0, new Defence(25));
    bangles = new HandGear("Bangles of Telepathy", "Telepathy", 0, new Defence(10));
    bracelets = new HandGear("Bracelets of Flame", "Flame", 0, new Attack(8));
    fingerRings = new HandGear("FingerRings of Sight", "Sight", 0, new Attack(-2));
    fitBand = new HandGear("FitBand of Speed", "Speed", 0, new Attack(20));
