...
public class GearDescription {
   ...
   */
  public GearDescription(GearDescription gearDescriptionToCopy) throws NullPointerException {
    if (Objects.isNull(gearDescriptionToCopy)) {
      throw new NullPointerException("gearDescription to copy value cannot be null");
    }
